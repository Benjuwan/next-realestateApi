...
function FilterActionBtns() {
    ...
    const changeInputValue: (inputEl: SyntheticEvent<HTMLInputElement>) => void = (inputEl: SyntheticEvent<HTMLInputElement>) => {
    ...
    return (
        <div className={filterStyle.FilterActionBtns}>
            ...
            <div className={filterStyle.filterPlace}>
                <form action="" onSubmit={(formEl: SyntheticEvent<HTMLFormElement>) => {
                    formEl.preventDefault();
                    FilterPlace(isInputValue);
                }}>
                    <input type="text" value={isInputValue} onInput={(inputEl: SyntheticEvent<HTMLInputElement>) => {
